...
# Written by Ben. Feel free to ask if you have any questions!
...
cat <<EOF
Note that you may pass -flags or --flags to this script as you would to
ansible-playbook. Eg: --help for help or -vvvv for connection debugging.
